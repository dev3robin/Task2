...
const Header = ({isDark,toggleTheme}) => {
  return (
      <div className='relative z-10 max-w-[1440px] min-h-[85vh] bg-white overflow-hidden'
      style={{ backgroundColor: 'var(--bg)', color: 'var(--text)' }}>
        <div className='absolute top-0 left-0 -z-10 w-full h-full'>
          <img src="/bg-img/headerbg.png" alt="" className='w-full h-full' />
        </div>

        <nav className='h-[114px] px-[15px] rounded-bl-3xl rounded-br-3xl backdrop-blur-3xl'>
